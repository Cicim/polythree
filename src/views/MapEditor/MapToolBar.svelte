    ...
    <div class="buttons">
        ...
        {#key $changed}
            <ToolButton
                ...
                title={`Undo ${
                    changes.top === 0
                        ? ""
                        : `${changes.stack[changes.top - 1]?.getName?.()} (${
                              changes.stack[changes.top - 1]?.tab
                          })`
                }`}
        ...
        {#key $changed}
            <ToolButton
                icon="mdi:redo"
                title={`Redo ${
                    changes.top === changes.stack.length
                        ? ""
                        : `${changes.stack[changes.top]?.getName?.()} (${
                              changes.stack[changes.top]?.tab
                          })`
                }`}
